(function($, window, document) {
    function Paging(el, options) {
        ...
        this.options = {
            ...
            __edwin__find_li_num: options.__edwin__find_li_num, //Edwin添加，显示的页码数量
    ...
    Paging.prototype = {
        ...
        createDom: function() {
            ...
            var that = this,
                ...
                __edwin__find_li_num = that.options.__edwin__find_li_num, //Edwin添加，显示的页码数量
                wrapLength = 0;
            totalPages > __edwin__find_li_num ? wrapLength = __edwin__find_li_num * liWidth+8 : wrapLength = totalPages * liWidth+8;
            ...
            content = '<div class="pagger-box"><div id="__edwin__first_line"><button type="button"  class="turnPage first-page">首页</button>' +
                ...
                '<button type="button" class="last-page turnPage">尾页</button></div><div id="__edwin__two_line">' +
                jumpDom +
